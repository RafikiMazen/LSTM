...
df = pd.read_csv("D:\Bachelor\Datasets\sensor.csv")
...
features = df.drop(['index'],axis=1)
features.index = df['timestamp']
features.drop(['timestamp','machine_status','sensor_15','sensor_50'],inplace=True, axis=1)
features.dropna(axis=0,inplace=True)
dataset = features[['sensor_12','sensor_13']].values
# dataset = dataset[1:]
